...
let buttonCreature = {
    ...
    species: "Kylosian",
    favoriteFood: "Zarg-nuts",
    moods: ["still", "overjoyous", "crying", "laughing", "honest", "confused"]
};
...
$("#needy-button").click(function () {
    ...
    message = message + "<p> If you keep clicking me I," +buttonCreature.name + 
     " will personally show up and eat your planet's rations of "
      + buttonCreature.favoriteFood +".<p>";
    $("#output").html(message);
